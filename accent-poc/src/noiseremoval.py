...
rate, temp= wavfile.read(FilePath + 'Recording.wav')
# temp = temp/32768
# np.asanyarray(temp)
# data= temp.flatten()
# #data = np.reshape(data, (1,np.product(data.shape)))[0] #reshaping the data
# # print(data)
# # print(data)
#
# def fftnoise(f):
...
# print(output)
#
# scipy.io.wavfile.write('out.wav',rate=44100,data=output)



input_file = FilePath + 'vinod.wav'
